...
|--------|-------|
| Total BRs | 47 |
| ✅ Fully Covered (unit + E2E) | 18 (38%) |
| ⚠️ Unit Covered (no E2E yet) | 28 (60%) |
| ❌ Untested | 0 (0%) |
| 🚫 Not implemented | 1 |
| Total ACs | 65 |
...
| BR-006 | Treatment state transitions are forward-only: `diagnosed` →  | ✅ (2) | ✅ (3) | ✅ (2) | ✅ FULLY_COVERED |
...
| BR-012 | Invoice state lifecycle: `draft` → `sent` → `paid` / `partia | ✅ (4) | ✅ (1) | ✅ (1) | ✅ FULLY_COVERED |
...
| BR-018 | Lab order state lifecycle: `ordered` → `in_fabrication` → `d | ✅ (1) | ❌ | ✅ (1) | ✅ FULLY_COVERED |
