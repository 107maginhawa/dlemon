...
| `applyDentalDiscount` | dental-billing | POST | `/dental/billing/invoices/{invoiceId}/discount` | keep | _triage pending_ |
| `applyTemplate` | dental-visit | POST | `/dental/visits/{visitId}/apply-template/{templateId}` | keep | _triage pending_ |
| `approveAmendment` | dental-clinical | POST | `/dental/visits/{visitId}/amendments/{amendmentId}/approve` | keep | _triage pending_ |
| `approveErasure` | dental-erasure | POST | `/dental/erasure-requests/{id}/approve` | keep | _triage pending_ |
...
| `cancelAppointment` | dental-scheduling | DELETE | `/dental/appointments/{appointmentId}` | keep | _triage pending_ |
...
| `carryOverTreatments` | dental-visit | POST | `/dental/visits/{visitId}/carry-over` | keep | _triage pending_ |
...
| `createConsentTemplate` | dental-org | POST | `/dental/branches/{branchId}/consent-templates` | keep | _triage pending_ |
...
| `createDentalPaymentPlan` | dental-billing | POST | `/dental/billing/invoices/{invoiceId}/plan` | keep | _triage pending_ |
...
| `createPatient` | patient | POST | `/patients` | keep | _triage pending_ |
...
| `createTreatmentTemplate` | dental-visit | POST | `/dental/treatment-templates` | keep | _triage pending_ |
...
| `deleteConsentTemplate` | dental-org | DELETE | `/dental/branches/{branchId}/consent-templates/{id}` | keep | _triage pending_ |
...
| `deleteTreatmentTemplate` | dental-visit | DELETE | `/dental/treatment-templates/{id}` | keep | _triage pending_ |
...
| `getAuditEvents` | dental-audit | GET | `/dental/audit-events` | keep | _triage pending_ |
...
| `getDentalPaymentReceipt` | dental-billing | GET | `/dental/billing/invoices/{invoiceId}/payments/{paymentId}/receipt` | keep | _triage pending_ |
...
| `ImagingMgmt_deleteImage` | dental-imaging | DELETE | `/dental/imaging/images/{imageId}` | keep | _triage pending_ |
...
| `ImagingMgmt_updateImageModality` | dental-imaging | PATCH | `/dental/imaging/images/{imageId}/modality` | keep | _triage pending_ |
...
| `listAmendments` | dental-clinical | GET | `/dental/visits/{visitId}/amendments` | keep | _triage pending_ |
...
| `listConsentRefusals` | dental-clinical | GET | `/dental/visits/{visitId}/consent-refusals` | keep | _triage pending_ |
| `listConsentTemplates` | dental-org | GET | `/dental/branches/{branchId}/consent-templates` | keep | _triage pending_ |
...
| `listErasureRequests` | dental-erasure | GET | `/dental/erasure-requests` | keep | _triage pending_ |
...
| `listNotifications` | notifs | GET | `/notifs` | keep | _triage pending_ |
...
| `listPrescriptions` | dental-clinical | GET | `/dental/visits/{visitId}/prescriptions` | keep | _triage pending_ |
...
| `listTreatmentTemplates` | dental-visit | GET | `/dental/treatment-templates` | keep | _triage pending_ |
| `listWaitlist` | dental-scheduling | GET | `/dental/branches/{branchId}/waitlist` | keep | _triage pending_ |
| `markAllNotificationsAsRead` | notifs | POST | `/notifs/read-all` | keep | _triage pending_ |
...
| `markNotificationAsRead` | notifs | POST | `/notifs/{notif}/read` | keep | _triage pending_ |
...
| `rejectErasure` | dental-erasure | POST | `/dental/erasure-requests/{id}/reject` | keep | _triage pending_ |
...
| `revokeConsentForm` | dental-clinical | PATCH | `/dental/visits/{visitId}/consents/{cid}/revoke` | keep | _triage pending_ |
...
| `updateConsentTemplate` | dental-org | PATCH | `/dental/branches/{branchId}/consent-templates/{id}` | keep | _triage pending_ |
...
| `updateDentalPatient` | dental-patient | PATCH | `/dental/patients/{id}` | keep | _triage pending_ |
...
| `updateMember` | dental-org | PATCH | `/dental/org/members/{memberId}` | keep | _triage pending_ |
| `updatePatient` | patient | PATCH | `/patients/{id}` | keep | _triage pending_ |
| `updatePatientCommunicationConsent` | dental-patient | PATCH | `/dental/patients/{patientId}/communication-consent` | keep | _triage pending_ |
...
| `updatePrescription` | dental-clinical | PATCH | `/dental/visits/{visitId}/prescriptions/{prescriptionId}` | keep | _triage pending_ |
...
| `updateTreatmentTemplate` | dental-visit | PATCH | `/dental/treatment-templates/{id}` | keep | _triage pending_ |
| `updateVideoCallParticipant` | comms | PATCH | `/comms/chat-rooms/{room}/video-call/participant` | keep | _triage pending_ |
| `voidDentalPayment` | dental-billing | POST | `/dental/billing/invoices/{invoiceId}/payments/{paymentId}/void` | keep | _triage pending_ |
