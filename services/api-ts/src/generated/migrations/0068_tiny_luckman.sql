...
ALTER TABLE "consultation_note" DROP CONSTRAINT "consultation_note_patient_id_patient_id_fk";
--> statement-breakpoint
ALTER TABLE "consultation_note" DROP CONSTRAINT "consultation_note_provider_id_provider_id_fk";
