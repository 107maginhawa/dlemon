...
const STUDY_ITEMS: PatientImageItem[] = [
  {
    ...
    // §capture-date: taken well before it was uploaded → the list shows
    // "Taken … / Added …" and sorts by the capture date.
    capturedAt: '2025-11-15T00:00:00.000Z',
    capturedAtSource: 'dicom_tag',
    downloadUrl: null,
    isDiagnostic: true,
    qualityStatus: 'ok',
    retakeReason: null,
